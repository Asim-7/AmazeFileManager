...
public class MainFragment extends Fragment
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Log.d("Asim","MainFragment onCreate");
  ...
  public void onViewCreated(
    ...
    Log.d("Asim","MainFragment onViewCreated");
    mainFragmentViewModel = new ViewModelProvider(this).get(MainFragmentViewModel.class);
  ...
  public ArrayList<LayoutElementParcelable> getElementsList() {
    Log.d("Asim","MainFragment getElementsList LIST_ELEMENTS:"+mainFragmentViewModel.getListElements());
